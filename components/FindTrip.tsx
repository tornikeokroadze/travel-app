    ...
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 lg:w-auto w-full h-96 lg:h-auto px-4 lg:px-0">
      ...
      >
        <div className="grid grid-cols-2 lg:flex shadow-lg rounded-t-lg lg:rounded-l-lg lg:rounded-tr-none overflow-hidden bg-white">
          ...
          {/* Start Date */}
          <div className="flex flex-col w-full lg:w-48 h-24 border-r border-gray-300 px-6 justify-center">
        ...
        <button
          type="submit"
          className="relative w-full lg:w-48 min-h-16 lg:min-h-24 px-6 bg-primary-100 font-semibold text-white overflow-hidden rounded-b-lg lg:rounded-r-lg lg:rounded-bl-none group"
        >
